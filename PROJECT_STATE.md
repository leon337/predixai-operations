...
```text
STATE_VERSION=1.2.6
UPDATED_AT_UTC=2026-08-17T09:14:35Z
...
KNOWN_PENDING=FINAL_PASS_STATE_SYNC_CI;HUMAN_GATE_PR32_MERGE;R5_BACKUP_RESTORE;R6_CICD_ROLLBACK;R7_OBSERVABILITY;PRODUCTION_NOT_CONFIRMED
NEXT_AUTHORIZED_ACTION=REQUEST_HUMAN_GATE_FOR_PR32_MERGE_AFTER_FINAL_STATE_SYNC_CI
```
...
Após o CI desta sincronização final de estado, solicitar HUMAN_GATE específico para o merge do PR #32. Nenhum merge está autorizado por este documento.
