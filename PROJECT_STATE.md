...
```text
STATE_VERSION=1.1.0
UPDATED_AT_UTC=2026-08-17T06:59:20Z
...
PRIMARY_ACTIVE_SUBTASK=REMEDIATE_AND_RETEST_GOV03_F01_TO_F08
...
BLOCKERS=RETEST_CI_AND_HUMAN_GATE_FOR_PR28
NEXT_AUTHORIZED_ACTION=RETEST_GOV03_PR28_HEAD
```
...
Retestar o HEAD exato do PR #28, verificar diff, CI e threads, registrar decisão final do GOV-03 e solicitar HUMAN_GATE separado somente se o resultado for PASS.
